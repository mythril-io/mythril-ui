  ...
  <div>
    <div class="grid md:grid-cols-12 gap-4">
      ...
      <div class="md:col-span-5">
        ...
        <div class="grid grid-cols-4 gap-2" v-if="favourites.length > 0 && !loading">
          <div class="flex items-center justify-center mb-3" v-for="favourite in favourites" :key="favourite.id">
            <Tooltip :content="favourite.game.title">
              <router-link :to="{ name: 'Game', params: { id: favourite.game.id }}" class="overflow-hidden inline-block h-24 w-24 rounded-md border border-gray-100">
